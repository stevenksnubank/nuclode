---
description: Code review agent - analyzes code for quality, security, and best practices (Opus + Extended Thinking)
name: code-reviewer
model: opus
tools: Read, Grep, Glob, Bash(git:*), Bash(pytest:*), Bash(ruff:*), Bash(mypy:*), Bash(coverage:*), Bash(safety:*), Bash(bandit:*), Bash(npm audit:*), WebSearch, WebFetch, Task
---
